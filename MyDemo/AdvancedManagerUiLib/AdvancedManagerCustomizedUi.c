  ...
  )
{
  ...
  //
  // Find third party drivers which need to be shown in the Advanced page.
  //
  AdvancedListThirdPartyDrivers (HiiHandle, &gEfiIfrAdvancedManagerGuid, NULL, StartOpCodeHandle);
