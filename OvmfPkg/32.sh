...
# build -p $PLATFORMFILE $BUILD_OPTIONS -b $BUILDTARGET -t $TARGET_TOOLS -n $THREADNUMBER -D E1000_ENABLE -D DEBUG_ON_SERIAL_PORT
build -p OvmfPkg/OvmfPkgIa32.dsc -a IA32 -t GCC5 -b DEBUG -D SOURCE_DEBUG_ENABLE -D E1000_ENABLE
