...
/**
  ...
  @retval EFI_BUFFER_TOO_SMALL   The output buffer is too small.
**/
EFI_STATUS
EFIAPI
LoongsonSendTpmCmd (
...
/**
  ...
  @retval EFI_INVALID_PARAMETER  One or more input parameters are invalid.
  @retval EFI_DEVICE_ERROR       The RNG engine failed to generate random data.
**/
EFI_STATUS
EFIAPI
LoongsonRngGenerate (
...
/**
  ...
  @retval EFI_DEVICE_ERROR       The SE device failed to set the RNG seed.
**/
EFI_STATUS
EFIAPI
LoongsonRngSeed (
...
/**
  ...
  @retval EFI_SUCCESS       SE read access was enabled successfully.
  @retval EFI_DEVICE_ERROR  Failed to enable SE read access.
**/
EFI_STATUS
EFIAPI
SeReadEnable (
...
/**
  ...
  @note This interface returns UINT8 instead of EFI_STATUS. New code should
        prefer LoongsonSeDetect().
**/
UINT8
EFIAPI
SeDetect (
...
/**
  Deprecated compatibility wrapper for SeDetect().

  @retval 1  The SE device exists.
  @retval 0  The SE device does not exist.

  @deprecated The function name contains a typo. Use SeDetect() instead.
**/
UINT8
EFIAPI
SeDetect (
...
/**
  ...
  @retval EFI_INVALID_PARAMETER  The DDR memory region is invalid.
